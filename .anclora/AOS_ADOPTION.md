...
Declaración de adopción AOS para `anclora-synergi`.

## Metadatos

- Repository Name: anclora-synergi
...
`anclora-synergi` forma parte del ecosistema Anclora como aplicación operativa Next.js.
